...
var htmlRenderInto = function (t, e) {
  ...
  tplElementStatsDomain = function (t, e) {
    ...
    return (
      ...
      (a.querySelector(".time-" + RANGE_TODAY).innerHTML =
        tplHtmlTimeObjectFragment({
          value: t.times[RANGE_TODAY],
          resolution: RESOLUTION_HOURS,
        })),
      (a.querySelector(".time-" + RANGE_AVERAGE).innerHTML =
        tplHtmlTimeObjectFragment({
          value: t.times[RANGE_AVERAGE],
          resolution: RESOLUTION_HOURS,
        })),
      (a.querySelector(".time-" + RANGE_AVERAGE + "-pure").innerHTML =
        tplHtmlTimeObjectFragment({
          value: t.times[RANGE_AVERAGE + "-pure"],
          resolution: RESOLUTION_HOURS,
        })),
      (a.querySelector(".time-" + RANGE_ALLTIME).innerHTML =
        tplHtmlTimeObjectFragment({
  ...
  tplElementStatsOverall = function (t, e) {
    return (
      ...
      (e.querySelector(".time-" + RANGE_TODAY).innerHTML =
        tplHtmlTimeObjectFragment({
          value: t.times[RANGE_TODAY],
          resolution: RESOLUTION_HOURS,
        })),
      (e.querySelector(".time-" + RANGE_AVERAGE).innerHTML =
        tplHtmlTimeObjectFragment({
          value: t.times[RANGE_AVERAGE],
          resolution: RESOLUTION_HOURS,
        })),
      (e.querySelector(".time-" + RANGE_AVERAGE + "-pure").innerHTML =
        tplHtmlTimeObjectFragment({
          value: t.times[RANGE_AVERAGE + "-pure"],
          resolution: RESOLUTION_HOURS,
        })),
      (e.querySelector(".time-" + RANGE_ALLTIME).innerHTML =
        tplHtmlTimeObjectFragment({
          value: t.times[RANGE_ALLTIME],
          resolution: RESOLUTION_DAYS,
        })),
