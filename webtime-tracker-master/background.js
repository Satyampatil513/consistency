...
chrome.tabs.onActivated.addListener(function (e) {
  ...
  //   if (!domains.hasOwnProperty(url)) {
  //     console.error('URL not found in the data.');
  //     return null;
  //   }
    
  //   var domainData = domains[url];
  //   if (!domainData.days.hasOwnProperty(today)) {
  //     console.error('No data available for the present day.');
  //     return null;
  //   }
    
  //   var seconds = domainData.days[today].seconds;
  ...
  // var presentDayTime = getTimeForPresentDay('www.example.com');
  // if (presentDayTime) {
